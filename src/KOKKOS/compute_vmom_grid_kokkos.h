...
ComputeStyle(vmom/grid/kk,ComputeVmomGridKokkos)

#else

#ifndef SPARTA_COMPUTE_VMOM_GRID_KOKKOS_H
#define SPARTA_COMPUTE_VMOM_GRID_KOKKOS_H
...
struct TagComputeVmomGrid_compute_per_grid_atomic{};

struct TagComputeVmomGrid_compute_per_grid{};
struct TagComputeVmomGrid_post_process_grid{};

class ComputeVmomGridKokkos : public ComputeVmomGrid, public KokkosBase {
 public:
  ComputeVmomGridKokkos(class SPARTA *, int, char **);
  ~ComputeVmomGridKokkos();
  ...
  void operator()(TagComputeVmomGrid_compute_per_grid_atomic<NEED_ATOMICS>, const int&) const;

  KOKKOS_INLINE_FUNCTION
  void operator()(TagComputeVmomGrid_compute_per_grid, const int&) const;

  KOKKOS_INLINE_FUNCTION
  void operator()(TagComputeVmomGrid_post_process_grid, const int&) const;
